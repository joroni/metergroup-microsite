...
tags:
  ...
  - media
---
A post to demonstrate how a blog post looks on meter. Content is all set in the “Body” field as markdown and Eleventy transforms it into a proper HTML post. You can also edit the markdown file directly if you prefer not to use the CMS.
